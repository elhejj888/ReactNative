...
try {
  ...
  const throwErrorOnJS = Worklets.createRunOnJS((message, stack) => {
    ...
    if (global.ErrorUtils != null)
      ...
      global.ErrorUtils.reportFatalError(error);else if (global.__ErrorUtils != null) global.__ErrorUtils.reportFatalError(error);else console.error('Frame Processor Error:', error);
  });
  throwJSError = error => {
    'worklet';
 ...
 * @internal
 */
export function wrapFrameProcessorWithRefCounting(frameProcessor) {
  return frame => {
    'worklet';
