 ...
 * ```
 */
function createSkiaFrameProcessor(frameProcessor, surfaceHolder, offscreenTextures) {
  ...
  const createDrawableFrameProxy = (frame, canvas) => {
    'worklet';
  ...
  return {
    frameProcessor: (0, _FrameProcessorPlugins.wrapFrameProcessorWithRefCounting)(frame => {
      'worklet';
...
function useSkiaFrameProcessor(frameProcessor, dependencies) {
  ...
  (0, _react.useEffect)(() => {
    return () => {
      ...
      (_VisionCameraProxy$wo = _FrameProcessorPlugins.VisionCameraProxy.workletContext) === null || _VisionCameraProxy$wo === void 0 || _VisionCameraProxy$wo.runAsync(() => {
        'worklet';
  ...
  return (0, _react.useMemo)(() => createSkiaFrameProcessor(frameProcessor, surface, offscreenTextures),
